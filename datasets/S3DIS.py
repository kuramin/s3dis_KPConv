    ...
    def load_subsampled_clouds(self):
        ...
        for i, file_path in enumerate(self.files):
            ...
            if exists(KDTree_file):
                ...
                sub_colors = np.vstack((data['scalar_Autoclass_0'], 
                                        data['scalar_Autoclass_1'], 
                                        data['scalar_Autoclass_2'],
                                        data['scalar_Autoclass_3'],
                                        data['scalar_Intensity'],
                                        data['scalar_NumberOfReturns'],
                                        data['scalar_ReturnNumber'])).T
                ...
                colors = np.vstack((data['scalar_Autoclass_0'], 
                                    data['scalar_Autoclass_1'], 
                                    data['scalar_Autoclass_2'],
                                    data['scalar_Autoclass_3'],
                                    data['scalar_Intensity'],
...
class S3DISSampler(Sampler):
    ...
    def calibration(self, dataloader, untouched_ratio=0.9, verbose=False, force_redo=False):
        ...
        if redo:
            ...
            expected_N = 20000  #kuramin changed it from 10000
            ...
            low_pass_T = 30  #kuramin changed it from 100
            Kp = expected_N / 200
            Ki = 0.001 * Kp
            Kd = 5 * Kp
            finer = False
